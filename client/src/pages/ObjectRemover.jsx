...
const ObjectRemover = () => {
  ...
  const handleRemoveObject = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${backendUrl}/api/enhance/remove-objects`, formData, {
        headers: {
      ...
      toast.error(error.response?.data?.message || 'Failed to remove objects')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50/30 pt-20'>
      ...
      >
        ...
        <motion.p 
          ...
          variants={itemVariants}
        >
          Remove unwanted objects from your photos seamlessly with AI-powered content-aware fill.
        </motion.p>
        ...
        >
          ...
          >
            ...
            <label htmlFor="image-upload" className="cursor-pointer">
              <div className="flex flex-col items-center">
                ...
                <p className="text-lg font-medium text-secondary-700 mb-2">Upload Image to Remove Objects</p>
          ...
          >
            ...
            <div className='bg-white p-6 rounded-xl shadow-lg'>
              <h3 className='text-lg font-semibold mb-4 text-center text-gray-800'>Object Removed</h3>
              <div className='aspect-square bg-gray-100 rounded-lg flex items-center justify-center'>
                {loading ? (
                  <div className='flex flex-col items-center'>
                    <div className='w-12 h-12 border-4 border-secondary-500 border-t-transparent rounded-full animate-spin mb-4'></div>
                    <p className='text-gray-600'>Removing objects...</p>
                  </div>
                ) : processedImage ? (
